...
changed to .cpp for better editing in VSCode.

This file can be compipled and linked by "Processing"

But the app file generated by "Processing" is too large (>250M), so we decide change to 
"Flutter" which is a good programming environment for iOS and Andriod.

We gave up on "Qt" because the project will not provide desktop app. 
---------------------------------------------------------------------------------*/
